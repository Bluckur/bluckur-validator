...
B.createGenesisBlockAsync = function createGenesisBlockAsync(publicKey) {
  return new Promise((resolve, reject) => {
    ...
    genisisBlock.transactions.push.apply(this.createGenesisBlockTransactions(publicKey));
...
/**
 * [createGenesisBlockTransactions description]
 * @param  {String}  publicKey [description]
 * @return {Boolean}           [description]
 */
B.createGenesisBlockTransactions = function createGenesisBlockTransactions(publicKey) {
  return [
